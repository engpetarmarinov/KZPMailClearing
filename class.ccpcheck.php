...
class KZPMailClearing
{
	...
	/**
	 * Read the headers and match custom headers
	 * @param resource $ch resource a cURL handle
	 * @param string $header
	 ...
	 * @param string $start regex string to match for the begining of the header
	 * @param string $end regex string to match for the end of the header
	 * @param string $header
	 * @return string|false
	 */
	...
	/**
	 * Do the preparation for the emails, before invoking the actual check
	 */
